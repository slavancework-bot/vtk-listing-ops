...
export default defineConfig({
  ...
  webServer: process.env.PHASE2_E2E ? [
    { command: "pnpm --filter @workspace/api-server dev", url: "http://127.0.0.1:4174/api/readyz", reuseExistingServer: false, env: { PORT:"4174",APP_ENV:"staging",NODE_ENV:"test",ALLOW_DEVELOPMENT_IDENTITY:"true",ALLOW_NONPRODUCTION_DATABASE:"true",ALLOW_NONPRODUCTION_STORAGE:"true",STAGING_FILE_ROOT:process.env.STAGING_FILE_ROOT??".phase2-files",CORS_ALLOWED_ORIGINS:"http://127.0.0.1:4173" } },
