...
test("controlled import, draft restore, final persistence, and authoritative progress cross PostgreSQL", async () => {
  ...
  const firstDraft={...draft(first.id,"development-employee","server-backed draft"),conditionCode:"A" as const};await phase2.saveDraft(first.id,"development-employee",firstDraft as unknown as Record<string,unknown>,"00000000-0000-4000-8000-000000000051");
